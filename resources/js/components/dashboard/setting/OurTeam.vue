								...
								<v-card-text>
									<v-container grid-list-md>
										<v-layout wrap>
	                                        ...
	                                        <v-col cols="12">
												<v-text-field
													v-model="editedItem.designation_en"
												...
												<v-col cols="12">
												<v-text-field
													v-model="editedItem.designation_ar"
...
export default {
	...
	data: () => ({
		...
		[
			...
			{ text: "Designation", value: "designation_en" },
	...
	methods: {
		...
		async save() 
		{
			...
			if (this.editedIndex > -1) 
			{
				try 
				{
					let { data } = await axios({
						method: "put",
						url: "/app/ourteam/" + this.editedItem.id,
		...
		async remove() 
		{
			...
			try {
				let { data } = await axios({
					method: "delete",
					url: "/app/ourteam/" + this.dataList[this.dataIndex].id
				});
				if (data.status) {
